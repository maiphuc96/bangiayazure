			...
			?>
 				<tr>
					...
					<td id="tieude">
						...
						"><a id="a_off_tag_link" href="index.php?p=donhangdaxulichitiet&iddh=<?php echo $row_dsDonHang['id_don_hang'];?>" style="text-decoration:none; color:white;"> Chi tiết </a></button>
					<!-- href="index.php?p=suasanphamy&amp;idsp=21" -->
						<button id="btn_chitiet" type="button" class="btn btn-sm btn-info"><a id="a_off_tag_link" onclick="return confirm('Bạn có muốn xóa hay không?')" href="index.php?p=xoadonhangdxl&iddh=<?php echo $row_dsDonHang['id_don_hang'];?>" style="text-decoration:none; color:white;"> Xóa </a></button>
					</td>
 				</tr>
			<?php
			}
