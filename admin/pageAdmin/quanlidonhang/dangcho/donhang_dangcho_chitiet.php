...
?>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-transform: uppercase; width: 100%;color: #ffffff;font-size: 32px;background-color: #fe980f;text-align: center;">
				...
				<tbody> 
					...
					<tr>
						...
						<td class="cart_quantity">
							<div style="padding-left: 20px;" class="cart_quantity_button" id="">
	...
	<div class="payment-options" style="margin-bottom: 0px">
		<?php 
			echo"<a";
			echo ' onclick="return confirm(';echo "'Bạn chắc chắn muốn xác nhận đơn hàng này?'";echo ')"';
			echo "class='btn btn-primary col-xs-12 col-sm-5 col-md-5 col-lg-5'  href='index.php?p=xacnhandonhangKH&iddh=";
			echo $iddh;echo"''>Xác nhận đơn hàng</a>";						
		?>

		<?php 
			echo"<a";
			echo ' onclick="return confirm(';echo "'Bạn chắc chắn hủy bỏ đơn hàng này?'";echo ')"';
			echo "class='btn btn-primary col-xs-12 col-sm-offset-2 col-sm-5 col-md-offset-2 col-md-5 col-lg-offset-2 col-lg-5'  href='index.php?p=huybodonhangKH&iddh=";
