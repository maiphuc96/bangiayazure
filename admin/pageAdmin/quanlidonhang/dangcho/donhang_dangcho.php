...
?>
 ...
 <div class="row" >
 	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" style="margin-top: 12px;padding-right: 0px;padding-left: 0px;">
			...
			?>
 				<tr>
					...
					<td id="tieude">
						...
						"><a id="a_off_tag_link" href="index.php?p=donhangdangchochitiet&iddh=<?php echo $row_dsDonHang['id_don_hang'];?>" style="text-decoration:none; color:white;"> Chi tiết </a></button>
					<!-- href="index.php?p=suasanphamy&amp;idsp=21" -->
						<button id="btn_chitiet" type="button" class="btn btn-sm btn-info"><a id="a_off_tag_link" onclick="return confirm('Bạn có muốn xóa hay không?')" href="index.php?p=xoadonhang&iddh=<?php echo $row_dsDonHang['id_don_hang'];?>" style="text-decoration:none; color:white;"> Xóa </a></button>
					</td>
 				</tr>
			<?php
			}
